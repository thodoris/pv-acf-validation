# PV-ACF validation snapshot — 2026-06-06T02-58-50

Frozen for the thesis validation chapter. Generated by `npm run freeze`.

- Snapshot stamp: `2026-06-06T02-58-50` (the export this analysis was run against).
- Respondents (SHORT, post-cut-off): **34**.
