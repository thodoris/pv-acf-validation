# PV-ACF validation snapshot — 2026-06-04T23-08-47

Frozen for the thesis validation chapter. Generated by `npm run freeze`.

- Snapshot stamp: `2026-06-04T23-08-47` (the export this analysis was run against).
- Respondents (SHORT, post-cut-off): **28**.
