/* C-9 Expert Validation Platform — content layer.
   ...
   - CONTENT.profile       — profile-screen fields
   - CONTENT.grounding     — platform-wide grounding screens (2)
   - CONTENT.clusters      — per-cluster setup content
   - CONTENT.questions     — keyed registry of every question/screen
   - CONTENT.instruments   — Cluster 3 instrument data
   - CONTENT.concepts      — reference-overlay concept cards

   Phase A: question stems and subtitles are drafted from the cluster files;
   rationale cards and full source-material panels arrive in Phase B. */
