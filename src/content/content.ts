...
export const CONTENT: ContentRoot = ((): ContentRoot => {
  ...
  C.questions = {
    ...
    "c1-q1": {
      ...
      clusterPosition: { ordinal: 1, totalInFull: 8 },
    ...
    "c1-q2": {
      ...
      clusterPosition: { ordinal: 2, totalInFull: 8 },
      registers: ["recognition"],
      ...
      questions: [
        {
          ...
          clusterPosition: { ordinal: 3, totalInFull: 8 },
          registers: ["judgment"],
        ...
        },
        {
          ...
          clusterPosition: { ordinal: 4, totalInFull: 8 },
          registers: ["recognition"],
    ...
    "c1-q5": {
      ...
      clusterPosition: { ordinal: 5, totalInFull: 8 },
      registers: ["judgment"],
    ...
    "c1-q6": {
      ...
      clusterPosition: { ordinal: 6, totalInFull: 8 },
      registers: ["judgment"],
    ...
    "c1-q7": {
      ...
      clusterPosition: { ordinal: 7, totalInFull: 8 },
      registers: ["judgment"],
    ...
    "c2-q1": {
      ...
      clusterPosition: { ordinal: 1, totalInFull: 6 },
      registers: ["judgment"],
    ...
    "c2-q2": {
      ...
      clusterPosition: { ordinal: 2, totalInFull: 6 },
      registers: ["judgment"],
    ...
    "c2-q3": {
      ...
      clusterPosition: { ordinal: 3, totalInFull: 6 },
      registers: ["judgment"],
...
"c2-q5": {
    ...
    "c2-q6": {
      ...
      clusterPosition: { ordinal: 6, totalInFull: 6 },
      registers: ["judgment"],
    ...
    "c4-q1": {
      ...
      clusterPosition: { ordinal: 1, totalInFull: 2 },
      registers: [],
    ...
    "c4-q2": {
      ...
      clusterPosition: { ordinal: 2, totalInFull: 2 },
      registers: [],
